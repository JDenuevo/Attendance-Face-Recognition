...
<title>Staff Policies | BERGS</title>
...
<div class="container-fluid">
  <div class="row">
      ...
      <div class="position-sticky list-group pt-2"><br><br><br>
        ...
        <ul class="nav flex-column d-md-block">
          ...
          <label class = "pb-2 fs-5 ms-1">Manage</label>
            ...
            <li class="nav-item pb-1">
                <a class="nav-link list-group-item border text-truncate rounded active" href="s_policies"data-toggle="tooltip" title="Policies"><i class="fa-solid fa-file-lines"></i> Policies</a>
            </li>
    ...
    <main class="col-md-10 col-lg-10 ms-sm-auto px-md-4">
      ...
      <form action="s_add_policy" method="post">
          ...
          <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success" data-bs-toggle="modal" name="s_add_policy" data-toggle="tooltip" data-placement="left" title="Add new policy now!"><i class="fa-solid fa-plus"></i> Add Policy</button>
              </div>
            </div>
          </div>
        </div>
...
?>
  ...
  ?>
      <form class="" action="s_update_policy?id=<?php echo $row1['policy_id']; ?>" method="post">
