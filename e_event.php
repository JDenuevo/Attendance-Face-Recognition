...
<title>Employee Events | BERGS</title>
      ...
      <div class="position-sticky list-group pt-2"><br><br><br>
        ...
        <ul class="nav flex-column d-md-block">
          ...
          <ul class = "list-unstyled fw-normal pb-2 small">
            ...
            <li class="nav-item pb-1">
              <a class="nav-link list-group-item border text-truncate rounded active" data-toggle="tooltip" data-placement="left" title="Set a Event!" href="e_event"><i class="fa-solid fa-calendar-week"></i> Event</a>
            </li>
            <li class="nav-item pb-1">
...
<?php
  ...
  $sql = "SELECT * FROM `bergs_event` WHERE event_to = '$dept' OR event_to = 'To All Employees' ORDER BY event_num DESC";
                          ...
                          <div class="modal-content">
                              <div class="modal-body">
                                ...
                                <div class="text-start">
                                    ...
                                    <label class="text-start"><?php echo $row['event_from']; ?></label>
                                    <br>
