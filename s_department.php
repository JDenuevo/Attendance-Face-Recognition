...
<title>Staff Modify Department | BERGS</title>
...
<ul class="nav flex-column d-md-block">
          ...
          <label class = "pb-2 fs-5 ms-1">Manage</label>
            ...
            <li class="nav-item pb-1">
                <a class="nav-link list-group-item border text-truncate rounded active" href="s_department" data-toggle="tooltip" title="Department"><i class="fa-solid fa-building"></i> Department</a>
            </li>
          ...
          <?php
            ...
            <tr class="text-center align-middle">
              ...
              <td class="d-flex-list justify-content-evenly align-middle" width = "150px">
                ...
                <!-- Button for Remove
                <a href="#" onclick="showDeleteConfirmation('<?php echo $row['dep_num']; ?>');" class="btn btn-sm btn-danger mt-1">
...
function showDeleteConfirmation(dep_num) {
    Swal.fire({
      ...
      window.location.href = 's_department_remove.php?dep_num=' + dep_num;
...
<!-- Off Canvas for Profile Button -->
  ...
  <form action="s_department_add.php" method="POST">
...
?>
  ...
  ?>
  <form action="s_department_update.php" method="POST">
...
if (window.performance) {
  if (performance.navigation.type == 1) {
    ...
    window.location.href = "s_department";
  }
}</script>
