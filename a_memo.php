...
<title>Admin Memorandum | BERGS</title>
          ...
          <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success" data-bs-toggle="modal" name="add_memo" data-toggle="tooltip" data-placement="left" title="Add new memo now!"><i class="fa-solid fa-plus"></i> Add memo</button>
              </div>
            </div>
          </div>
        </div>
...
<!--================================================================== END NG OPEN MODAL WAG GAGALAWIN UNLESS JHEMAR DENUEVO O KIAN UBANA ANG PANGALAN MO (PAAYOS NG UI) ================================================-->
       <script>
          function showDeleteConfirmation(memo_num) {
            Swal.fire({
              title: 'REMOVE MEMORANDUM!',
              text: 'Do you want to remove this memorandum?',
              icon: 'warning',
