...
if (isset($_POST['s_add_memo']) && $_POST['select-deduction'] === "indiv") {
    $errors1 = array();
    $errors2 = array();
    ...
    // Get data to insert from form submission
        ...
        if (!empty($errors1)) {
          ...
          header('Location: s_memo?errors1=' . urlencode($errorString1));
          exit();
      }
      ...
      header('Location: s_memo?errors2=' . urlencode($errorString1));
      exit();
  }
}
//==========================================================END INDIVIDUAL==========================================================
...
//==========================================================BY DEPT==========================================================
    ...
    else if (isset($_POST['s_add_memo']) && $_POST['select-deduction'] === "by-dept") {
      $errors1 = array();
      $errors2 = array();
    ...
    //========================================================== TO ALL ==========================================================
    else if (isset($_POST['s_add_memo']) && $_POST['select-deduction'] === "to-all") {
      $errors1 = array();
      $errors2 = array();
