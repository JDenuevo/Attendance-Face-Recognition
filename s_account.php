...
<title>Staff Manage Accounts | BERGS</title>
      ...
      <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
          ...
          <ul class="navbar-nav m-auto">
            ...
            <li class="nav-item">
              <a class="nav-link px-3 active" href="s_account">Account</a>
            </li>
          </ul>
            ...
            <script>
              function showDeleteConfirmation(id) {
                Swal.fire({
                  ...
                  window.location.href = 's_remove_account?id=' + id;
...
<form action="s_update_account.php" method="POST">
...
if (window.performance) {
  if (performance.navigation.type == 1) {
    ...
    window.location.href = "s_account";
  }
}</script>
