...
<title>Staff Memorandum | BERGS</title>
  ...
  <div class="row">
      ...
      <div class="position-sticky list-group pt-2"><br><br><br>
       ...
       <ul class="nav flex-column d-md-block">
          ...
          <li class="nav-item pb-1">
            <a class="nav-link list-group-item border text-truncate rounded active" data-toggle="tooltip" data-placement="left" title="Set a Memo!" href="s_memo"><i class="fa-solid fa-message"></i> Memorandum</a>
          </li>
    ...
    <main class="col-md-10 col-lg-10 ms-sm-auto px-md-4">
      ...
      <div class="page-header pt-2">
        <h2>Staff Manage Memorandum</h2>
      </div>
      <hr>

      <div class="text-end">
        <button class="btn btn-sm btn-outline-success" data-bs-toggle="modal" data-bs-target="#creatememo" type="button" data-toggle="tooltip" data-placement="left" title="Create new Memorandum!"> <i class="fa-solid fa-plus"></i> Create New</button>
      </div>
...
<!--================================================================== DONT TOUCH THIS TAPOS NA TO (JHEMAR LANG AAYOS NG UI NITO)=====================================================================================================-->
      <form action="s_add_memo.php" method="post">
        <div class="modal fade modal-lg" id="creatememo" tabindex="-1" aria-labelledby="creatememo1" aria-hidden="true">
          <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title fw-bold">Create a new memo</h5>
              ...
              <div class="modal-body">
                <div class="row">
                    <div class="col-12 py-2">
                         <input class="form-control" type="text" placeholder="Enter your Memorandum Subject" name="m_subject" autocomplete="off" required>
                    </div>
                </div>
              </div>
              <div class="modal-body">
                <div class="row">
                    <div class="col-6 py-2">
                        <select class="form-select" name="select-deduction" id="select-deduction" required>
                          <option value="wala to" id="wala to" selected disabled>Select Memorandum options</option>
                          ...
                          <option value="indiv" id="indiv"><i class="fa-solid fa-person"></i> Individual</option>
                        </select>
                    </div>
                    <div class="col-6 py-2 text-start">
                        <select class="form-select" name="select-dept" id="select-dept" required>
                         ...
                         <input class="form-control" name="employee_id" id="employee_id" type="number" placeholder="Employee ID" min = "18000000" max = "99999999" autocomplete="off" required>
                    </div>
              ...
              <div class="modal-body">
                <textarea class="form-control" placeholder="Enter your Memorandum Description" id="p_description" name="m_description"></textarea>
              </div>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success" data-bs-toggle="modal" name="s_add_memo" data-toggle="tooltip" data-placement="left" title="Add new memo now!"><i class="fa-solid fa-plus"></i> Add memo</button>
              </div>
            </div>
          </div>
        </div>
...
<!--================================================================== START NG OPEN MODAL WAG GAGALAWIN UNLESS JHEMAR DENUEVO O KIAN UBANA ANG PANGALAN MO (PAAYOS NG UI) ================================================-->
      ...
      <?php
  $sql = "SELECT * FROM `bergs_memo` ORDER BY memo_num DESC";
  $result = mysqli_query($conn, $sql);
  ...
  ?>
   ...
   <div class="col-12 col-lg-4 col-md-4 col-sm-12 py-2" id="pmemo">
                      ...
                      <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                          <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                  ...
                                  <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" onclick="showDeleteConfirmation('<?php echo $row['memo_num']; ?>');" data-toggle="tooltip" data-placement="left" title="Remove this Memorandum?"><i class="fa-solid fa-trash"></i> Remove</button>
                                </div>
                          </div>
                      </div>
                  </div>
...
<!--================================================================== END NG OPEN MODAL WAG GAGALAWIN UNLESS JHEMAR DENUEVO O KIAN UBANA ANG PANGALAN MO (PAAYOS NG UI) ================================================-->
        <script>
            function showDeleteConfirmation(memo_num) {
                  Swal.fire({
                    title: 'REMOVE EVENT!',
...
selectDeduction.addEventListener('change', (event) => {
  ...
  } else if (selectedValue === 'indiv') {
    // Disable select-dept input and enable employee_id input
    selectDept.disabled = true;
    selectDept.style.display = 'none';
