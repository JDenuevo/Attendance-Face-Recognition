...
<title>Admin List of Employee | BERGS</title>
...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-10 col-lg-10 ms-sm-auto px-md-4">
      ...
      <!--    </ul>-->
      <!--</div>-->
        <a class = "text-decoration-none float-end" href="a_list_deleted">
...
function showDeleteConfirmation(id) {
    Swal.fire({
      ...
      window.location.href = 'a_remove_employee.php?id=' + id;
...
<form action="a_list_addface.php" method="POST"  enctype="multipart/form-data">
<!-- Modal Add Face-->
  ...
  <?php
    ...
    <?php
      ...
      if($rs=$conn->query($sql)){
          while ($row=$rs->fetch_assoc()) {
      ?>
      <form class="form" id="form" action="a_update_employee.php" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                 <div class="row rows-col-3">
                    ...
                    <div class="col-12 col-lg-4 col-md-4 col-sm-12">
                        <input class="form-control" type="text" placeholder="Card Number" name="cardnum" value="<?php echo $row['cardnum'] ?>" autocomplete="off" >
                ...
                <div class="row rows-col-3">
                    ...
                    <div class="col-12 col-lg-4 col-md-4 col-sm-12">
                        <input class="form-control" type="text" placeholder="Title" name="title" value="<?php echo $row['title'] ?>" autocomplete="off" >
                    ...
                    <div class="col-12 col-lg-4 col-md-4 col-sm-12">
                        <select class="form-select" name="privilege" autocomplete="off" required>
                            <option value="Administrator" <?php echo ($row['privilege'] == 'Administrator') ? 'selected' : ''; ?>>Administrator</option>
            ...
            <div class="row rows-col-3">
                ...
                <div class="col-12 col-lg-4 col-md-4 col-sm-12">
                  <select class="form-select" id="nationality" name="nationality" required>
                    <option value="" <?php echo ($row['nationality'] == '') ? 'selected' : ''; ?>>SELECT NATIONALITY</option>
