...
<title>Staff Attendance | BERGS</title>
    ...
    <main class="col-md-10 col-lg-10 ms-sm-auto px-md-4">
      ...
      <ul class="dropdown-menu px-2" aria-labelledby="multiSelectDropdown" id ="multiSelectDropdown">
        ...
        <li><label><input type="checkbox" value="11" class="checkbox-column" checked> Marked</label></li>
            ...
            <button class="btn btn-sm btn-outline-primary mx-1 float-end" type="button" onclick="showDeleteConfirmation('haha');" title="Attendance" ><i class="fa-solid fa-clipboard-user"></i> Logged in Attendance</button>
            <script>
            ...
            <div class="btn-group mx-1 float-end">
                ...
                <ul class="dropdown-menu dropdown-menu-light text-small shadow text-center">
                    <li>
                        <button class="btn btn-sm btn-outline-secondary" type="button" data-bs-toggle="modal" data-bs-target="#s_summary_monthly" aria-expanded="false" data-toggle="tooltip" data-placement="left" title="Attendance Summary">
                            <i class="fa-solid fa-table-list"></i>
                            Attendance Summary
                        </button>
                    </li>
                    <li>
                        <button class="btn btn-sm btn-outline-secondary mt-1" type="button" data-bs-toggle="modal" data-bs-target="#s_summary" aria-expanded="false" data-toggle="tooltip" data-placement="left" title="Attendance Information">
                            <i class="fa-solid fa-table-list"></i>
...
<!-- Modal for Monthly-->
<form id="myForm" action="s_export.php" method="POST" target="_blank">
<div class="modal fade" id="s_summary_monthly" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        ...
                        <script>
                            ...
                            function checkMonthYear() {
                                if (monthYearInput.value.trim() === '') {
                                    ...
                                    const url = `s_specmonth.php?date_month=${formattedDate}`;
...
<!-- Modal for Attendance -->
    <form id="myForm" action="s_attendance_print.php" method="POST" target="_blank">
        <div class="modal fade" id="s_summary" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
