...
//==========================================================BY DEPT==========================================================
    ...
    if (isset($_POST['add_event']) && $_POST['select-deduction'] === "by-dept") {
      $errors1 = array();
      $errors2 = array();
        ...
        $event_desc = nl2br($event_desc); // convert line breaks to <br> tags
          $dep_name = trim($_POST['select-dept']);
            ...
            if($success == 'okay'){
              ...
              header('Location: a_event?errors1=' . urlencode($errorString1));
              exit();
            }else if($success == 'no') {
              $errors2[] = "Something went wrong!";
              $errorString1 = implode(',', $errors2);
              header('Location: a_event?errors2=' . urlencode($errorString1));
              exit();
            }
    ...
    //========================================================== TO ALL ==========================================================
    else if (isset($_POST['add_event']) && $_POST['select-deduction'] === "to-all") {
      $errors1 = array();
      $errors2 = array();
