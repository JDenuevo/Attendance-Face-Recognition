...
<title>Staff Events | BERGS</title>
...
<ul class="nav flex-column d-md-block">
          ...
          <li class="nav-item pb-1">
            <a class="nav-link list-group-item border text-truncate rounded active" data-toggle="tooltip" data-placement="left" title="Set a Event!" href="s_event"><i class="fa-solid fa-calendar-week"></i> Event</a>
          </li>
...
<!--================================================================== DONT TOUCH THIS TAPOS NA TO (JHEMAR LANG AAYOS NG UI NITO)=====================================================================================================-->
      <form action="s_add_event.php" method="post">
          ...
          <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success" data-bs-toggle="modal" name="s_add_event" data-toggle="tooltip" data-placement="left" title="Add new Event now!"><i class="fa-solid fa-plus"></i> Add Event</button>
