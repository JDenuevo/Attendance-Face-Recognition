...
if (isset($_POST['add_btn'])) {
    ...
    // Get data to insert from form submission
        ...
        $sql = "SELECT MAX(dep_num) AS last_dep_number FROM bergs_department";
        ...
        $sql = "INSERT INTO bergs_department (dep_num, dep_name) VALUES ('$new_dep_number', '$dep_name')";
        ...
        $errors1[] = "Department was successfully added.";
          ...
          header('Location: a_department?errors1=' . urlencode($errorString1));
          exit();
      }
