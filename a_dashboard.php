...
<title>Admin Dashboard | BERGS</title>
      ...
      <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
          ...
          <ul class="navbar-nav m-auto">
            <li class="nav-item">
              <a class="nav-link active px-3" href="a_dashboard">Dashboard</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-4 col-md-4 col-sm-12 py-1">
            <div class="card text-bg-light border-primary">
              ...
              <div class="card-footer text-center bg-transparent" data-toggle="tooltip" title="View Employees">
                <a href="a_list" class="btn btn-sm btn-primary w-75"><i class="fa-solid fa-eye"></i> View Employees</a>
              </div>
          ...
          <div class="col-12 col-lg-4 col-md-4 col-sm-12 py-1">
            <div class="card text-bg-light border-info">
              ...
              <div class="card-footer text-center bg-transparent" data-toggle="tooltip" title="View Department">
                <a href="a_department" class="btn btn-sm btn-info w-75"><i class="fa-solid fa-eye"></i> View Departments</a>
              </div>
          ...
          <div class="col-12 col-lg-4 col-md-4 col-sm-12 py-1">
            <div class="card text-bg-light border-success">
              ...
              <div class="card-footer text-center bg-transparent" data-toggle="tooltip" title="View Presents">
                <a href="a_attendance" class="btn btn-sm btn-success w-75 text-light"><i class="fa-solid fa-eye"></i> View Presents</a>
              </div>
          ...
          <div class="col-12 col-lg-4 col-md-4 col-sm-12 py-1">
            <div class="card text-bg-light border-danger">
              ...
              <div class="card-footer text-center bg-transparent" data-toggle="tooltip" title="View Shifts">
                <a href="a_shift" class="btn btn-sm btn-danger w-75"><i class="fa-solid fa-eye"></i> View Shifts</a>
              </div>
          ...
          <div class="col-12 col-lg-4 col-md-4 col-sm-12 py-1">
            <div class="card text-bg-light border-warning">
              ...
              <div class="card-footer text-center bg-transparent" data-toggle="tooltip" title="View Events">
                <a href="a_event" class="btn btn-sm btn-warning w-75"><i class="fa-solid fa-eye"></i> View Events</a>
              </div>
          ...
          <div class="col-12 col-lg-4 col-md-4 col-sm-12 py-1">
            <div class="card text-bg-light border-secondary">
              ...
              <div class="card-footer text-center bg-transparent" data-toggle="tooltip" title="View Memorandum">
                <a href="a_memo" class="btn btn-sm btn-secondary w-75"><i class="fa-solid fa-eye"></i> View Memorandum</a>
              </div>
              ...
              <div class="col-12 col-lg-4 col-md-4 col-sm-12 py-1">
                <div class="card mx-1 my-1">
                  <div class="card-body text-center border border-dark rounded">
                    ...
                    <a href="a_policies" class="btn btn-primary" data-toggle="tooltip" title="Go to Policy">Go to Policy</a>
                  </div>
                </div>
              </div>
              ...
              <div class="col-12 col-lg-4 col-md-4 col-sm-12 py-1">
                <div class="card mx-1 my-1">
                  <div class="card-body text-center border border-dark rounded">
                    ...
                    <a href="a_memo" class="btn btn-primary" data-toggle="tooltip" title="Go to Memorandum" >Go to Memorandum</a>
                  </div>
                </div>
              </div>
              ...
              <div class="col-12 col-lg-4 col-md-4 col-sm-12 py-1">
                <div class="card mx-1 my-1">
                  <div class="card-body text-center border border-dark rounded">
                    ...
                    <a href="a_event" class="btn btn-primary" data-toggle="tooltip" title="Go to Events" >Go to Event</a>
                  </div>
                </div>
              </div>
        </div>
